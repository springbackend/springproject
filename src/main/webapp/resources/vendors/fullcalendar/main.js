                ...
                if (_this.isDragging) {
                    ...
                    if (validMutation) {
                        ...
                        if (receivingContext_1 === initialContext_1) {
                            ...
                            console.log(JSON.stringify(eventChangeArg));
                            
                            sendUpdatedEventToBackend(eventChangeArg);
       						 
       						 function sendUpdatedEventToBackend(eventChangeArg) {
							    ...
							    fetch("/event/update", {
							        ...
							        body: JSON.stringify(eventChangeArg),
							    })
