                      ...
                      <li class="nav-item"><a class="nav-link dropdown-indicator" href="#nv-admin" data-bs-toggle="collapse" aria-expanded="true" aria-controls="nv-admin">
                        ...
                        <div class="parent-wrapper">
                          <ul class="nav collapse parent show" data-bs-parent="#e-commerce" id="nv-admin">
                            ...
                            <li class="nav-item"><a class="nav-link active" href="resources/apps/e-commerce/admin/products.html" data-bs-toggle="" aria-expanded="false">
                ...
                <table class="table fs-9 mb-0">
                  ...
                  <tbody class="list" id="products-table-body">
                    ...
                    <tr class="position-static">
                      ...
                      <td class="product align-middle ps-4"><a class="fw-semibold line-clamp-3 mb-0" href="resources/apps/e-commerce/landing/product-details.html">2021 Apple 12.9-inch iPad Pro (Wi‑Fi, 128GB) - Space Gray</a></td>
