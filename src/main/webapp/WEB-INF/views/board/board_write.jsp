...
.dropdown_tone a:hover {
	background-color: #f1f1f1
}

.dropdown:hover .dropdown_tone {
	display: block;
}
...
<body>
	...
	<form>
		<div class="outer">
					...
					<td colspan="2">
						<div class="dropdown">
							...
							<div class="dropdown_tone">
								<a href="#">봄 웜톤</a> <a href="#">여름 쿨톤</a> <a href="#">가을 웜톤</a>
								<a href="#">겨울 쿨톤</a>
							</div>
						</div>
				...
				<tr>
					<td colspan="2">
						<div class="dropdown">
							...
							<div class="dropdown_tone">
								<a href="#">립</a> <a href="#">아이셰도우</a> <a href="#">블러셔</a> <a
									href="#">파운데이션</a>
							</div>
						</div>
					</td>
			...
			<div align="right">
				<button class="btn_back" onclick="back();"
					style="vertical-align: middle">
					<span class="back"> Back</span>
				</button>
				<button class="btn_send" onclick="send(this.form);"
					style="vertical-align: middle">
					<span class="send">Upload </span>
				</button>
			</div>
