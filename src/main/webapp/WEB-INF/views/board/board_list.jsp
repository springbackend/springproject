                      ...
                      <li class="nav-item"><a class="nav-link dropdown-indicator" href="#nv-admin" data-bs-toggle="collapse" aria-expanded="true" aria-controls="nv-admin">
                        ...
                        <div class="parent-wrapper">
                          <ul class="nav collapse parent show" data-bs-parent="#e-commerce" id="nv-admin">
                            ...
                            <li class="nav-item"><a class="nav-link" href="resources/apps/e-commerce/admin/orders.html" data-bs-toggle="" aria-expanded="false">
                ...
                <div class="nav-item-wrapper"><a class="nav-link dropdown-indicator label-1" href="#nv-kanban" role="button" data-bs-toggle="collapse" aria-expanded="true" aria-controls="nv-kanban">
                  ...
                  <div class="parent-wrapper label-1">
                    <ul class="nav collapse parent show" data-bs-parent="#navbarVerticalCollapse" id="nv-kanban">
                      ...
                      <li class="nav-item"><a class="nav-link active" href="resources/apps/kanban/boards.html" data-bs-toggle="" aria-expanded="false">
              ...
              <ul class="dropdown-menu navbar-dropdown-caret">
                ...
                <li class="dropdown"><a class="dropdown-item dropdown-toggle" id="kanban" href="#" data-bs-toggle="dropdown" data-bs-auto-close="outside">
                  ...
                  <ul class="dropdown-menu">
                    ...
                    <li><a class="dropdown-item active" href="resources/apps/kanban/boards.html">
        ...
        <div class="mb-9">
          ...
          <div class="px-4 px-lg-6 py-5 border-bottom border-translucent">
            ...
            <div class="swiper-theme-container">
              <div class="swiper swiper theme-slider" data-swiper='{"slidesPerView":1,"spaceBetween":24,"speed":800,"breakpoints":{"576":{"slidesPerView":2},"1200":{"slidesPerView":3},"1540":{"slidesPerView":4}}}'>
                <div class="swiper-wrapper">
                  <div class="swiper-slide"><a class="text-decoration-none" href="resources/apps/kanban/kanban.html">
                      <div class="card overflow-hidden bg-transparent h-100">
                        <div class="position-relative">
                          <div style="height: 128px; background-color: #4788A8"></div>
                          <div class="avatar-group position-absolute" style="bottom: 1rem; left: 1.5rem">
                            <div class="avatar avatar-m  border border-light-subtle rounded-circle">
                              <img class="rounded-circle " src="resources/assets/img/team/1.webp" alt="" />
                            </div>
                            <div class="avatar avatar-m  border border-light-subtle rounded-circle">
                            ...
                            <div class="avatar avatar-m  border border-light-subtle rounded-circle">
                              <img class="rounded-circle " src="resources/assets/img/team/avatar-placeholder.webp" alt="" />
                            </div>
                          </div>
                        </div>
                  ...
                  <div class="swiper-slide"><a class="text-decoration-none" href="resources/apps/kanban/kanban.html">
                      <div class="card overflow-hidden bg-transparent h-100">
                        <div class="position-relative"><img class="w-100" src="resources/assets/img/kanban/board-2.png" style="height: 128px;" alt="" />
                          <div class="avatar-group position-absolute" style="bottom: 1rem; left: 1.5rem">
                            <div class="avatar avatar-m  border border-light-subtle rounded-circle">
                              <img class="rounded-circle " src="resources/assets/img/team/5.webp" alt="" />
                            </div>
                            <div class="avatar avatar-m  border border-light-subtle rounded-circle">
                              <img class="rounded-circle " src="resources/assets/img/team/6.webp" alt="" />
                            </div>
                            <div class="avatar avatar-m  border border-light-subtle rounded-circle">
                              <img class="rounded-circle " src="resources/assets/img/team/7.webp" alt="" />
                            </div>
                            <div class="avatar avatar-m  border border-light-subtle rounded-circle">
                              <img class="rounded-circle " src="resources/assets/img/team/8.webp" alt="" />
                            </div>
                            <div class="avatar avatar-m  border border-light-subtle rounded-circle">
                              <img class="rounded-circle " src="resources/assets/img/team/9.webp" alt="" />
                            </div>
                          </div>
                        </div>
                        <div class="card-body d-flex flex-column justify-content-between">
                  ...
                  <div class="swiper-slide"><a class="text-decoration-none" href="resources/apps/kanban/kanban.html">
                      <div class="card overflow-hidden bg-transparent h-100">
                        <div class="position-relative"><img class="w-100" src="resources/assets/img/kanban/board-3.png" style="height: 128px;" alt="" />
                          <div class="avatar-group position-absolute" style="bottom: 1rem; left: 1.5rem">
                            <div class="avatar avatar-m  border border-light-subtle rounded-circle">
                              <img class="rounded-circle " src="resources/assets/img/team/10.webp" alt="" />
                            </div>
                            <div class="avatar avatar-m  border border-light-subtle rounded-circle">
                              <img class="rounded-circle " src="resources/assets/img/team/11.webp" alt="" />
                            </div>
                            <div class="avatar avatar-m  border border-light-subtle rounded-circle">
                              <img class="rounded-circle " src="resources/assets/img/team/12.webp" alt="" />
                            </div>
                            <div class="avatar avatar-m  border border-light-subtle rounded-circle">
                              <img class="rounded-circle " src="resources/assets/img/team/13.webp" alt="" />
                            </div>
                            <div class="avatar avatar-m  border border-light-subtle rounded-circle">
                              <img class="rounded-circle " src="resources/assets/img/team/avatar-placeholder.webp" alt="" />
                            </div>
                  ...
                  <div class="swiper-slide"><a class="text-decoration-none" href="resources/apps/kanban/kanban.html">
                      <div class="card overflow-hidden bg-transparent h-100">
                        <div class="position-relative"><img class="w-100" src="resources/assets/img/kanban/board-4.png" style="height: 128px;" alt="" />
                          <div class="avatar-group position-absolute" style="bottom: 1rem; left: 1.5rem">
                            <div class="avatar avatar-m  border border-light-subtle rounded-circle">
                              <img class="rounded-circle " src="resources/assets/img/team/14.webp" alt="" />
                            </div>
                            <div class="avatar avatar-m  border border-light-subtle rounded-circle">
                              <img class="rounded-circle " src="resources/assets/img/team/15.webp" alt="" />
                            </div>
                            <div class="avatar avatar-m  border border-light-subtle rounded-circle">
                              <img class="rounded-circle " src="resources/assets/img/team/16.webp" alt="" />
                            </div>
                          </div>
                        </div>
                        <div class="card-body d-flex flex-column justify-content-between">
                  ...
                  <div class="swiper-slide"><a class="btn btn-phoenix-primary d-flex flex-center h-100 w-100 fs-7 fw-semibold text-truncate" href="resources/apps/kanban/create-kanban-board.html"><span class="fa-solid fa-plus-circle fs-8 me-2"></span>Create New Board</a></div>
                </div>
              </div>
            ...
            <div class="swiper-theme-container">
              <div class="swiper swiper theme-slider" data-swiper='{"slidesPerView":1,"spaceBetween":24,"speed":800,"breakpoints":{"576":{"slidesPerView":2},"1200":{"slidesPerView":3},"1540":{"slidesPerView":4}}}'>
                <div class="swiper-wrapper">
                  <div class="swiper-slide"><a class="text-decoration-none" href="resources/apps/kanban/kanban.html">
                      <div class="card overflow-hidden bg-transparent h-100">
                        <div class="position-relative"><img class="w-100" src="resources/assets/img/kanban/board-5.png" style="height: 128px;" alt="" />
                          <div class="avatar-group position-absolute" style="bottom: 1rem; left: 1.5rem">
                            <div class="avatar avatar-m  border border-light-subtle rounded-circle">
                              <img class="rounded-circle " src="resources/assets/img/team/14.webp" alt="" />
                            </div>
                            <div class="avatar avatar-m  border border-light-subtle rounded-circle">
                              <img class="rounded-circle " src="resources/assets/img/team/19.webp" alt="" />
                            </div>
                            <div class="avatar avatar-m  border border-light-subtle rounded-circle">
                              <img class="rounded-circle " src="resources/assets/img/team/68.webp" alt="" />
                            </div>
                            <div class="avatar avatar-m  border border-light-subtle rounded-circle">
                              <img class="rounded-circle " src="resources/assets/img/team/69.webp" alt="" />
                            </div>
                            <div class="avatar avatar-m  border border-light-subtle rounded-circle">
                              <img class="rounded-circle " src="resources/assets/img/team/avatar-placeholder.webp" alt="" />
                            </div>
                  ...
                  <div class="swiper-slide"><a class="text-decoration-none" href="resources/apps/kanban/kanban.html">
                      <div class="card overflow-hidden bg-transparent h-100">
                        <div class="position-relative"><img class="w-100" src="resources/assets/img/kanban/board-6.png" style="height: 128px;" alt="" />
                          <div class="avatar-group position-absolute" style="bottom: 1rem; left: 1.5rem">
                            <div class="avatar avatar-m  border border-light-subtle rounded-circle">
                              <img class="rounded-circle " src="resources/assets/img/team/17.webp" alt="" />
                            </div>
                            <div class="avatar avatar-m  border border-light-subtle rounded-circle">
                              <img class="rounded-circle " src="resources/assets/img/team/18.webp" alt="" />
                            </div>
                            <div class="avatar avatar-m  border border-light-subtle rounded-circle">
                              <img class="rounded-circle " src="resources/assets/img/team/19.webp" alt="" />
                            </div>
                            <div class="avatar avatar-m  border border-light-subtle rounded-circle">
                              <img class="rounded-circle " src="resources/assets/img/team/20.webp" alt="" />
                            </div>
                          </div>
                        </div>
                        <div class="card-body d-flex flex-column justify-content-between">
                  ...
                  <div class="swiper-slide"><a class="text-decoration-none" href="resources/apps/kanban/kanban.html">
                      <div class="card overflow-hidden bg-transparent h-100">
                        <div class="position-relative">
                          ...
                          <div class="avatar-group position-absolute" style="bottom: 1rem; left: 1.5rem">
                            <div class="avatar avatar-m  border border-light-subtle rounded-circle">
                              <img class="rounded-circle " src="resources/assets/img/team/21.webp" alt="" />
                            </div>
                            <div class="avatar avatar-m  border border-light-subtle rounded-circle">
                              <img class="rounded-circle " src="resources/assets/img/team/19.webp" alt="" />
                            </div>
                            <div class="avatar avatar-m  border border-light-subtle rounded-circle">
                              <img class="rounded-circle " src="resources/assets/img/team/22.webp" alt="" />
                            </div>
                            <div class="avatar avatar-m  border border-light-subtle rounded-circle">
                              <img class="rounded-circle " src="resources/assets/img/team/23.webp" alt="" />
                            </div>
                            <div class="avatar avatar-m  border border-light-subtle rounded-circle">
                              <img class="rounded-circle " src="resources/assets/img/team/avatar-placeholder.webp" alt="" />
                            </div>
                  ...
                  <div class="swiper-slide"><a class="text-decoration-none" href="resources/apps/kanban/kanban.html">
                      <div class="card overflow-hidden bg-transparent h-100">
                        <div class="position-relative"><img class="w-100" src="resources/assets/img/kanban/board-8.png" style="height: 128px;" alt="" />
                          <div class="avatar-group position-absolute" style="bottom: 1rem; left: 1.5rem">
                            <div class="avatar avatar-m  border border-light-subtle rounded-circle">
                              <img class="rounded-circle " src="resources/assets/img/team/24.webp" alt="" />
                            </div>
                            <div class="avatar avatar-m  border border-light-subtle rounded-circle">
                              <img class="rounded-circle " src="resources/assets/img/team/19.webp" alt="" />
                            </div>
            ...
            <div class="swiper-theme-container">
              <div class="swiper swiper theme-slider" data-swiper='{"slidesPerView":1,"spaceBetween":24,"speed":800,"breakpoints":{"576":{"slidesPerView":2},"1200":{"slidesPerView":3},"1540":{"slidesPerView":4}}}'>
                <div class="swiper-wrapper">
                  <div class="swiper-slide"><a class="text-decoration-none" href="resources/apps/kanban/kanban.html">
                      <div class="card overflow-hidden bg-transparent h-100">
                        <div class="position-relative"><img class="w-100" src="resources/assets/img/kanban/board-9.png" style="height: 128px;" alt="" />
                          <div class="avatar-group position-absolute" style="bottom: 1rem; left: 1.5rem">
                            <div class="avatar avatar-m  border border-light-subtle rounded-circle">
                            ...
                            <div class="avatar avatar-m  border border-light-subtle rounded-circle">
                              <img class="rounded-circle " src="resources/assets/img/team/32.webp" alt="" />
                            </div>
                            <div class="avatar avatar-m  border border-light-subtle rounded-circle">
                              <img class="rounded-circle " src="resources/assets/img/team/33.webp" alt="" />
                            </div>
                            <div class="avatar avatar-m  border border-light-subtle rounded-circle">
                              <img class="rounded-circle " src="resources/assets/img/team/34.webp" alt="" />
                            </div>
                          </div>
                        </div>
                        <div class="card-body d-flex flex-column justify-content-between">
