		...
		<c:forEach var="vo" items="${list}">
			<div class="board">
				...
				<div class="button">
					...
					<input type="button" value="따봉" onclick="">
					<input type="button" value="댓글수" onclick="">
				</div>
			</div>
			<br>
		</c:forEach>
		
		<div class="btn"><button class="btn_write" onclick="location.href='board_write.do'" style="vertical-align:middle">
