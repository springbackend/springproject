					...
					<div class="row g-3 mb-9">
						...
						<div class="col-12 col-xl-6">
							<div class="gift-items-banner w-100 rounded-3 overflow-hidden">
								<div class="bg-holder z-n1 banner-bg"
									style="background-image: url(resources/assets/img/e-commerce/gift-items-banner-bg.png);"></div>
								<!--/.bg-holder-->
								<div class="banner-text text-md-center">
									<h2 class="text-white fw-bolder fs-xl-4">
										Get <span class="gradient-text">10% Off </span><br
											class="d-md-none"> on gift items
									</h2>
									<a class="btn btn-lg btn-primary rounded-pill banner-button"
										href="#!">Buy Now</a>
								</div>
						...
						<div class="col-12 col-xl-6">
							<div
								...
								<div class="bg-holder z-n1 banner-bg"
									style="background-image: url(resources/assets/img/e-commerce/best-in-market-bg.png);"></div>
								<!--/.bg-holder-->
								<div class="row align-items-center w-sm-100">
									<div class="col-8">
										<div class="banner-text">
											<h2 class="text-white fw-bolder fs-sm-4 mb-5">
												MI 11 Pro<br> <span class="fs-7 fs-sm-6"> Best
													in the market</span>
											</h2>
									...
									<div class="col-4">
										<img class="w-100 w-sm-75"
											src="resources/assets/img/e-commerce/5.png" alt="">
									</div>
								</div>
							</div>
						</div>
	            ...
	            <nav class="navbar navbar-expand-lg navbar-light px-0">
	              <div class="row gx-0 gy-2 w-100 flex-between-center">
	                <div class="col-auto"><a class="text-decoration-none" href="resources/index.html">
	                    <div class="d-flex align-items-center"><img src="resources/Logo/logo.png" width="100" />
	                      ...
	                      <div class="dropdown-menu dropdown-menu-end navbar-dropdown-caret py-0 dropdown-profile shadow border mt-2" aria-labelledby="navbarDropdownUser">
	                        <div class="card position-relative border-0">
	                        	...
	                        	<div style="margin-top:15px;">
		                            <div class="px-3"> <a class="btn btn-phoenix-secondary d-flex flex-center w-100" href="/beauty/login.do"> <span class="me-2" data-feather="log-in"> </span>로그인</a></div>
		                        	<div class="px-3"> <a class="btn btn-phoenix-secondary d-flex flex-center w-100" href="/beauty/regist.do"> <span class="me-2" data-feather="log-in"> </span>회원가입</a></div>
													...
													<div
														...
														<div>
															<div
																...
																<img class="img-fluid"
																	src="resources/productimages/${product.p_image }"
																	alt="" />
															</div>
						...
						<div class="row flex-center mb-15 mt-11 gy-6">
							<div class="col-auto">
								<img class="d-dark-none"
									...
									src="resources/assets/img/spot-illustrations/dark_30.png"
									alt="" width="305" />
							</div>
							<div class="col-auto">
