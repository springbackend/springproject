					...
					<div class="card">
						...
						<div class="card-body">
							<a class="stretched-link"
								href="product_view.do?p_idx=${product.p_idx }"><h5
									class="card-title">${product.p_name }</h5></a>
								...
								<div>
									...
									<br> <span class="text-body-quaternary fw-semibold ms-1">(${product.total_comments}명
										리뷰)</span>
									<p class="me-2 text-body text-decoration-line-through mb-0">
										<fmt:formatNumber value="${product.p_price}" type="currency"
