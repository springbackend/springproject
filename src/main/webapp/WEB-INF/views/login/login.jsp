  ...
  <body>
    ...
    <main class="main" id="top">
      <div class="container-fluid bg-body-tertiary dark__bg-gray-1200">
        <div class="bg-holder bg-auth-card-overlay" style="background-image:url(resources/assets/img/bg/37.png);"></div>
        <!--/.bg-holder-->
              ...
              <div class="card-body pe-md-0">
                <div class="row align-items-center gx-0 gy-7">
                  <div class="col-auto bg-body-highlight dark__bg-gray-1100 rounded-3 position-relative overflow-hidden auth-title-box">
                    <div class="bg-holder" style="background-image:url(resources/assets/img/bg/38.png);"></div>
                    <!--/.bg-holder-->
                    ...
                    <div class="position-relative z-n1 mb-6 d-none d-md-block text-center mt-md-15"><img class="auth-title-box-img d-dark-none" src="resources/assets/img/spot-illustrations/auth.png" alt="" /><img class="auth-title-box-img d-light-none" src="resources/assets/img/spot-illustrations/auth-dark.png" alt="" /></div>
                  </div>
                  <div class="col mx-auto">
                    <div class="auth-form-box">
                      <div class="text-center mb-7"><a class="d-flex flex-center text-decoration-none mb-4" href="resources/index.html">
                          <div class="d-flex align-items-center fw-bolder fs-3 d-inline-block"><img src="resources/assets/img/icons/logo.png" alt="phoenix" width="58" /></div>
                        </a>
                      ...
                      <div class="row flex-between-center mb-7">
                        ...
                        <div class="col-auto"><a class="fs-9 fw-semibold" href="resources/pages/authentication/card/forgot-password.html">Forgot Password?</a></div>
                      </div><button class="btn btn-primary w-100 mb-3">Sign In</button>
                      <div class="text-center"><a class="fs-9 fw-bold" href="resources/pages/authentication/card/sign-up.html">Create an account</a></div>
                    </div>
                  </div>
                </div>
              </div>
