	...
	<head>
		...
		<style>
			...
			.to-join{display:inline-block;
					 ...
					 top:23%;
					 height:70%;}
			.to-join *{text-align:center;} 
			.to-join-content{margin-top:60px;
							 margin-bottom:10px;
							 font-size:30px;
							 color:white;}
			.to-join-content div{font-size:15px;}
			.join-btn{padding:5px;
					  border:2px solid white;
					  color:white;
					  background-color:#ff66c4;
					  border-radius:10px;
					  width:40%;}
			.join-btn:hover{background-color:#595959;}
			...
			/* ID/pwd Styling */
			.id-div, .pwd-div{border:1px solid #595959;
							  width:80%;
					  		  padding:10px;
					   	 	  display:flex;
					   		  align-items:left;
			...
			.id-div span, .pwd-div span{width:30px;
										color:#595959;}
			#id, #pwd{border:none;}
			...
			#login-btn:hover{background-color:#1c5838;}
			...
			.join-find *{color:#595959;
						 font-size:14px;}
			.join-find *:hover{text-decoration:none;
							   color:#ff66c4;}
		...
		<form action="" method="post">
			...
			<div id="outer" class="d-flex justify-content-center">
				<div align="center" class="border">
					...
					<div class="form-check form-switch" id="form-check">
						<input class="form-check-input" type="checkbox" role="switch"
							id="yuji"> <label for="flexSwitchCheckDefault">로그인 상태 유지</label>
					</div>
					<br>
					<button type="button" id="login-btn"
						class="btn btn-primary" onclick="send(this.form);">로그인</button>	
					<div class="join-find">
				...
				<div class="to-join">
					...
					<div><button class="join-btn" onclick="location.href='regist.do'">
						회원가입</button></div>
				</div>
			</div>
		</form>
